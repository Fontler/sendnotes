...
new class extends Component {
    ...
    public function placeholder()
    {
        return <<<'HTML'
        <div role="status">
            <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-rose-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
